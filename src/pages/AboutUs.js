  ...
  return (
    <AnimationRevealPage>
      ...
      <div
        ...
        // }}
        // style={{
        //   background: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(${Truck1})  no-repeat center center fixed`,
        //   backgroundSize: "cover",
        // }}
        style={{
          background: `linear-gradient( rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0) ), url(${"/TruckSales2.png"})   no-repeat center fixed `,
