...
export default ({
  ...
  subheading = "Features",
  description = "We stand on our words",
}) => {
  /*
  ...
  const defaultCards = [
    {
      ...
      title: "Transparency",
      description:
        "Our brand is built on transparency. We carry you along on every stage of logistics or procurement. No hidden fees or charges",
    },
    {
