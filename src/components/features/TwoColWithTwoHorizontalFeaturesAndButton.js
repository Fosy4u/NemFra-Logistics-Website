...
const ImageColumn = tw(
  Column
)`md:w-4/12 flex-shrink-0 relative hidden lg:block`;
...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-primary-500">NemFra Tech.</span>
    </>
  ),
  ...
  const defaultFeatures = [
    {
      ...
      title: "Affordable",
      description:
        "We promise to offer you the best logistic rate we can - at par with the industry standard. As for purchasing trucks, we make sure you buy the best at European price.",
